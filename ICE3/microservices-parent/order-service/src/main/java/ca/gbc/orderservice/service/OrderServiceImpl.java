...
public class OrderServiceImpl{
    ...
    public void placeOrder(OrderRequest orderRequest) {
        ...
        List<OrderLineItem> orderLineItems = orderRequest
                ...
                .map(this::mapToDto)
                .toList();
//        List<OrderLineItem> orderLineItemListDto = (List<OrderLineItem>) orderRequest.getOrderLineItemListDto().stream().map((Function<? super OrderLineItem, ? extends OrderLineItem>) this::mapToModel).toList();
